...
import { CartItem, CreateCustomerInputs, EditCustomerProfileInput, OrderInputs, UserLoginInput } from '../dto/Customer.dto';
...
export const CustomerSignUp = async (req: Request, res: Response, next: NextFunction) => {
    ...
    if(result){
       ...
       let resp= await onRequestOTP(otp, phone);

       console.log(resp,"verfication")
...
export const CustomerVerfiy = async (req: Request, res: Response, next: NextFunction) => {

    const { otp } = req.body;
    const customer = req.user;
console.log(customer,"custmoer")
    if(customer){
